...
namespace RiverRaid.Objects.Tiles
{
    class EnlargmentSmall : ITile
    {
        ...
        public EnlargmentSmall(IComponent stage, Texture2D texture, Vector2 position)
        {
            Stage = stage;

            Position = position;
            Texture = texture;
            BoundingBox = new Rectangle((int)(Position.X * Globals.scaleX), (int)((Position.Y + Texture.Height * 0.4f) * Globals.scaleY),
